...
\subsection {The Vice--President External Affairs and Communications}
\index{Vice-President External and Communications}
\begin{longenum}[ label*=\arabic*., align=left]
    ...
    \index{Vice-President External and Communications!Liaison!University Students' Council}
    \index{Vice-President External and Communications!Liaison!MBA Association}
    \index{Vice-President External and Communications!Liaison!UWO Faculty and Staff Associations}
    \index{Vice-President External and Communications!Liaison!Departmental Graduate Associations}
    \index{PSAC 610!Liaison with VP-External}
    \index{Vice-President External and Communications!Liaison!PSAC 610}
    ...
    \item shall publish a monthly newsletter for the purpose of keeping graduate students informed of news and events that may interest them.
     \index{Vice-President External and Communications!Newsletter}
     |index{Newsletter}
    \item shall ensure that the Society's bulletin boards and websites are regularly updated.
     \index{Vice-President External and Communications!Website}
     |\index{Website}
\end{longenum}
...
\begin{longenum}[ label*=\thesubsection.\arabic*., align=left]
	\item Elections of Vice-President External and Communications, Vice-­-President Academic, Vice-­-President Student Services, and Vice-President Finance shall be held at the Council meeting specified in the Elections Table. The date of the election, eligibility requirements, and duties of the Executive position shall be advertised in the month before the election in appropriate campus media. The term shall be one year commencing on the first day of the month following the election. 
...
\begin{longenum}[ label*=\thesubsection.\arabic*., align=left]
    ...
    \index{Chain of Command}
		\begin{longenum}[ label*=\arabic*., align=left]
            ...
            \index{Vice-President External and Communications!Succession}
			\begin{longenum}[ label*=\arabic*., align=left]
...
\begin{longenum}[ label*=\thesubsection.\arabic*., align=left]
   ...
   \index{Vice-President External and Communications!Recall}
...
\begin{longenum}[ label*=\thesubsection.\arabic*., align=left]
   ...
   \index{Vice-President External and Communications!Recall!Vote}
...
\begin{longenum}[ label*=\thesection.\arabic*., align=left]
    ...
    \index{Vice-President External and Communications!Drafting and Issuing Statements}
    \index{Communications!Vice-President External and Communications}
    ...
    \index{Communications!Vice-President External and Communications!Exigent Circumstances}
\end{longenum}
\newpage
...
\item If an informal resolution is not successful or possible a formal complaint may be filed with the Ombudsperson for investigation and resolution as described in the SOGS disciplinary manua
