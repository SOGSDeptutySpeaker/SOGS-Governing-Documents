...
\begin{longenum}[ label*=\thesubsection.\arabic*., align=left]
    ...
    \index{Finance!Emergency Loan}
    \index{Vice-President Finance!Emergency Loan}
...
\index{Vice-President External Affairs and Communications}
\begin{longenum}[ label*=\arabic*., align=left]
    ...
    \item shall represent the Society as necessary at meetings of campus associations, including, but not limited to, the University Students' Council, the MBA Association, the PSAC 610,the UWO Faculty and Staff Associations, and departmental graduate student associations. \index{Vice-President External Affairs and Communications!Liaison}
    \index{PSAC 610!Liaison with VP-External}
    \index{Vice-President External and Communications!Liaison with PS}
    ...
    \item shall publish a monthly newsletter for the purpose of keeping graduate students informed of news and events that may interest them.
     \index{Vice-President External Affairs and Communications!Newsletter}
     |index{Newsletter}
    \item shall ensure that the Society's bulletin boards and websites are regularly updated.
     \index{Vice-President External Affairs and Communications!Website}
     |\index{Website}
\end{longenum}
...
\begin{longenum}[ label*=\thesubsection.\arabic*., align=left]
    ...
    \index{Chain of Command}
		\begin{longenum}[ label*=\arabic*., align=left]
            ...
            \index{Vice-President External Affairs!Succession}
			\begin{longenum}[ label*=\arabic*., align=left]
...
\begin{longenum}[ label*=\thesubsection.\arabic*., align=left]
   ...
   \index{Vice-President External Affairs and Communications!Recall}
...
\begin{longenum}[ label*=\thesubsection.\arabic*., align=left]
   ...
   \index{Vice-President External Affairs and Communications!Recall!Vote}
...
\begin{longenum}[ label*=\thesection.\arabic*., align=left]
    ...
    \index{Vice-President Finance, The!Contract Review Subcommittee}
...
\begin{longenum}[ label*=\thesection.\arabic*., align=left]
    ...
    \index{President!Loan Authority}
...
Bylaws.
    ...
    \item For the purposes of this bylaw, ``discrimination'' is defined as unequal or differential treatment of a person or persons that is not based on individual or group performance but is, instead, based on inappropriate considerations such as race, religion, skin colour, age, physical or mental capabilities, creed, ethnic background, sexual orientation, gender, place of origin, family status, a crime for which a pardon has been granted, and a medical condition. 
\end{longenum}
