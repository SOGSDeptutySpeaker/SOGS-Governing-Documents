...
\item shall provide all nominees for TA awards with a certificate that can be added to a teaching
dossier.
\item shall provide all nominees for TA Awards with a copy of anonymized comments pending
release by their authors.
