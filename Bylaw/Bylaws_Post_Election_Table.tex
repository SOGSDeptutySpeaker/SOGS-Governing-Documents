...
\begin{longenum}[ label*=\thesubsection.\arabic*., align=left]
    ...
    \begin{longenum}[ label*=\arabic*., align=left]
		\item An alternate Councilor is a member of the Society that has been appointed by their department/ unit/constituency to serve as a
		\begin{itemize}
		...
		\end{itemize}	 
		An alternate Councillor will assume all the responsibilities of the regular Councilor for the duration of the regular Councilor's absence.
